    ...
    internal sealed partial class SubReadStream : Stream
    {
        ...
        public override long Position
        {
            ...
            set
            {
                ...
                throw new NotSupportedException("not support seek");
            }
        }
        ...
        {
            if (_isDisposed)
                throw new ObjectDisposedException(GetType().ToString(), "SubReadStream");
        }

        private void ThrowIfCantRead()
        {
            if (!CanRead)
                throw new NotSupportedException("not support read");
        }
        ...
        {
            ThrowIfDisposed();
            throw new NotSupportedException("set length requires seek");
        }

        public override void Write(byte[] buffer, int offset, int count)
        {
            ThrowIfDisposed();
            throw new NotSupportedException("writting not support");
        }
